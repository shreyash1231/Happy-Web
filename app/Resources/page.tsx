...
export default async function Blog({ searchParams }: BlogPageProps) {
  ...
  const publishedPosts = posts.slice(3, 6);
    ...
    <>
      <div className="bg-[#E5DFD5] rounded-b-[60px] pb-10">
        ...
        <section className="pt-8 px-4 md:px-6 xl:p-8 mx-auto max-w-[1200px]">
          ...
          <p className="text-center text-[#736345] mt-4 max-w-3xl mx-auto text-sm md:text-lg">Articles are fetched live from your WordPress backend (happyho.in).</p>
